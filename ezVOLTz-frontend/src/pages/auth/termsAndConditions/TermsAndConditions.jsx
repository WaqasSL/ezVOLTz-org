...
const TermsAndConditions = () => {
  return (
    <div className='ez__Settings w-full h-full bg-ezMidWhite'>
      <div className='max-w-7xl mx-auto p-4 sm:p-6 md:p-8'>
        <h3 className='text-ezBlack text-2xl font-bold mb-1'>
          TERMS OF SERVICE
        </h3>
        <h6 className='text-semibild mb-10 text-xs sm:text-base'>
          Last updated May 13,2023
        </h6>
        <h4 className='text-ezBlack text-base sm:text-xl font-semibold mb-5'>
          AGREEMENT TO OUR LEGAL TERMS
        </h4>
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          We are AMPtium, Inc, doing business as ezVOLTz.com ("
          <strong className='font-semibold'>Company</strong>
          ," "<strong className='font-semibold'>we</strong>," "
          <strong className='font-semibold'>us</strong>, "
          <strong className='font-semibold'>our</strong>") ,a company registered
          in Virginia, United States at 2121 Crystal Drive, Suite 806, Crystal
          City, VA 22202.
        </p>
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          ...
          <a
            ...
            inline-block
            mx-1
            href='http://www.ezvoltz.com'
            target='_blank'
            rel='noopener noreferrer'
          >
            http://www.ezvoltz.com
          </a>{' '}
          (the <strong className='font-semibold'>"Site"</strong>), the mobile
          application ezvoltz (the{' '}
          <strong className='font-semibold'>"App"</strong>), as well as any
          other related products and services that refer or link to these legal
          terms (the <strong className='font-semibold'>"Legal Terms"</strong>)
          (collectively,{' '}
          <strong className='font-semibold'>the "Services"</strong>
          ).
        </p>
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          You can contact us by phone at 703-504-9801, email at
          info@ezvoltz.com, or by mail to 2121 Crystal Drive, Suite 806, Crystal
          City, VA 22202, United States.
        </p>
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity (
          <strong className='font-semibold'>"you"</strong>), and AMPtium, Inc,
        ...
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          ...
          upon posting or notifying you by info@ezvoltz.com, as stated in the
        ...
        <h4
          id='table-of-content'
          className='text-ezBlack uppercase text-base sm:text-xl font-semibold mb-5'
        >
          Table of contents
        </h4>
        <ul
          id='privacy-notes'
          className='list-inside list-decimal text-sm text-blue-700 uppercase mb-8 pl-5'
        >
          <li>
            <a className='text-blue-700' href='#our-services'>
              OUR SERVICES
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#intellectual-property-rights'>
              INTELLECTUAL PROPERTY RIGHTS
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#user-presentation'>
              USER REPRESENTATIONS
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#user-registration'>
              USER REGISTRATION
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#purchase-and-payment'>
              PURCHASES AND PAYMENT
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#free-trial'>
              FREE TRIAL
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#cancellation'>
              CANCELLATION
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#prohibited-activities'>
              PROHIBITED ACTIVITIES
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#user-generated-contributions'>
              USER GENERATED CONTRIBUTIONS
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#contribution-license'>
              CONTRIBUTION LICENSE
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#guidelines-for-reviews'>
              GUIDELINES FOR REVIEWS
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#mobile-application-license'>
              MOBILE APPLICATION LICENSE
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#social-media'>
              SOCIAL MEDIA
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#service-management'>
              SERVICES MANAGEMENT
            </a>
          </li>
          <li>
          ...
          <li>
            <a className='text-blue-700' href='#copyright-infringements'>
              COPYRIGHT INFRINGEMENTS
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#term-and-termination'>
          ...
          <li>
            <a className='text-blue-700' href='#governing-law'>
              GOVERNING LAW
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#dispute-resolution'>
              DISPUTE RESOLUTION
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#corrections'>
              CORRECTIONS
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#disclaimer'>
              DISCLAIMER
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#limitations-of-liability'>
              LIMITATIONS OF LIABILITY
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#indemnification'>
              INDEMNIFICATION
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#user-data'>
              USER DATA
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#electronic-communication'>
              ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#california-users'>
              CALIFORNIA USERS AND RESIDENTS
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#misc'>
              MISCELLANEOUS
            </a>
          </li>
          <li>
            <a className='text-blue-700' href='#contact-us'>
              CONTACT US
            </a>
          </li>
        </ul>
        ...
        <h5 className='text-ezBlack  text-base font-medium mb-5'>
        ...
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          <ul className='list-disc list-inside pl-5 mb-5'>
            <li className='mb-3'>access the Services; and</li>
            <li className='mb-3'>
        ...
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          ...
          please address your request to: info@ezvoltz.com. If we ever grant you
        ...
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          ...
          <ul className='list-disc list-inside pl-5 mb-5'>
            <li className='mb-3'>
              onfirm that you have read and agree with our "
              <a className='text-blue-700' href='#prohibited-activities'>
                PROHIBITED ACTIVITIES
              </a>
        ...
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          ...
          <ul className='list-disc list-inside pl-5 mb-5'>
            ...
            <li className='mb-3'>American Express</li>
            <li className='mb-3'>Discover</li>
        ...
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          ...
          info@ezvoltz.com or call us at 703-504-9801.
        </p>
        <h4
        ...
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          ...
          terms of agreement when using the App, e.g., if you have a VolP
        ...
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          ...
          place in Arlington, Virginia. Except as otherwise provided herein, the
        ...
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          ...
          and federal courts located in Arlington, Virginia, and the Parties
        ...
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          ...
          OMISSIONS IN ANY CONTENT AND MATERIALS OR FORANY LOSS OR DAMAGE OF ANY
          KIND INCURRED AS A RESULT OF THE USE OF ANY CONTENT POSTED,
          TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIATHE SERVICES. WE DO NOT
          WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT
          OR SERVICE ADVERTISED OR OFFERED BY ATHIRD PARTY THROUGH THE SERVICES,
        ...
        <p className='text-ezBlack text-xs sm:text-base mb-5'>
          <strong className='font-semibold'>AMPtium, Inc</strong>
          <br />
          <strong className='font-semibold'>
            2121 Crystal Drive, Suite 806
          </strong>
          <br />
          <strong className='font-semibold'>Crystal City, VA 22202</strong>
          <br />
          <strong className='font-semibold'>United States</strong>
          <br />
          <strong className='font-semibold'>Phone: 703-504-9801</strong>
          <br />
          <strong className='font-semibold'>info@ezvoltz.com</strong>
        </p>
      </div>
    </div>
  );
...
export default Layout(TermsAndConditions);
