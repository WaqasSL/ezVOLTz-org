...
import { loginWithFacebookSchema } from "../../../utils/schema";
import { CLOSE_GREY } from "../../../assets/icons";

const FacebookModal = ({ isVisible, closeModal, onSubmit, initialValues }) => {
  return (
      ...
      <SafeAreaView style={styles.safeAreaViewContainer}>
        ...
        <View style={styles.childContainer}>
          ...
          <Text style={styles.subInfo}>
            Fill out the following information in order to login with facebook
          </Text>
        </View>
        ...
        <Formik
          ...
          validateOnBlur={true}
          validationSchema={loginWithFacebookSchema}
        >
