...
import {DIR_RIGHT_GREEN, DIR_RIGHT_BLACK} from '../../../assets/icons';
import {dateComing} from '../../../utils/functions';

const UpcomingTripCard = ({data, onCardPress, onStartTripPress}) => {
    ...
    <Pressable style={styles.container} onPress={onCardPress}>
      <View style={styles.topContainer}>
        <View
          style={{
            ...
            backgroundColor: data?.startDate ? THEME : WILD_DOVE,
          }}>
          <Clock size={screenRem * 1.2} color={WHITE} />
        ...
        <Pressable style={styles.startTripContainer} onPress={onStartTripPress}>
          <DIR_RIGHT_GREEN height={screenRem * 1.2} width={screenRem * 1.2} />
        </Pressable>
      </View>
      ...
      <View style={styles.bottomContainer}>
        ...
        <View style={styles.bottomChildContainer}>
          ...
          <Text style={styles.infoText}>
            {isNull(data?.startDate) || isNull(data?.startTime)
              ? `Not Scheduled`
